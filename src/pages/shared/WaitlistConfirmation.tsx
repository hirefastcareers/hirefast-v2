...
export default function WaitlistConfirmation() {
  return (
    <div className="min-h-screen bg-[#0f1624] text-white p-6 flex flex-col items-center justify-center">
      <div className="w-full max-w-md rounded-xl border border-[#2a3a5c] bg-[#141f33] p-8 text-center">
        ...
        <div className="text-left rounded-lg border border-[#2a3a5c] bg-[#0f1624]/50 p-4 mb-6">
          <p className="text-white font-medium text-sm mb-2">What happens next</p>
          <ul className="text-[#6b7fa3] text-sm space-y-2 list-disc list-inside">
        ...
        <Link
          to="/recruiters"
          className="mt-3 block text-sm text-[#6b7fa3] hover:text-white text-center"
        >
