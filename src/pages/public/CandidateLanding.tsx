...
export default function CandidateLanding() {
  ...
  return (
    <div className="min-h-screen bg-[#0f1624] text-white font-[Inter,system-ui,sans-serif]">
      ...
      <section className="pt-12 pb-16 md:pt-20 md:pb-24 max-w-4xl">
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
          ...
          <a
            ...
            className="text-[#6b7fa3] hover:text-[#3b6ef5] text-sm font-medium transition-colors"
          >
            How it works
          </a>
        </div>
      ...
      <section className="pb-16">
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 max-w-4xl mx-auto">
          ...
          <div className="rounded-xl border border-[#2a3a5c] bg-[#141f33] p-5">
            ...
            <p className="text-[#6b7fa3] text-sm">Magic link access only</p>
          </div>
          <div className="rounded-xl border border-[#2a3a5c] bg-[#141f33] p-5">
            <p className="text-[#3b6ef5] font-bold text-xl mb-1">
              Verified Employers
            </p>
            <p className="text-[#6b7fa3] text-sm">Every role is checked</p>
          </div>
        </div>
      </section>
      ...
      <section
        id="how-it-works"
        className="py-16 bg-[#141f33]/50 rounded-2xl"
      >
        <div className="max-w-4xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="rounded-xl border border-[#2a3a5c] bg-[#141f33] p-6">
              ...
              <p className="text-[#6b7fa3] text-sm font-medium mb-1">Step 1</p>
            ...
            <div className="rounded-xl border border-[#2a3a5c] bg-[#141f33] p-6">
              ...
              <p className="text-[#6b7fa3] text-sm font-medium mb-1">Step 2</p>
              <h3 className="text-lg font-semibold mb-2">
            ...
            <div className="rounded-xl border border-[#2a3a5c] bg-[#141f33] p-6">
              ...
              <p className="text-[#6b7fa3] text-sm font-medium mb-1">Step 3</p>
              <h3 className="text-lg font-semibold mb-2">
                Apply in one tap
              </h3>
              <p className="text-[#6b7fa3] text-sm">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex flex-wrap gap-3">
            {SECTORS.map((sector) => (
              <span
                key={sector}
                className="inline-flex items-center px-4 py-2 rounded-full border border-[#3b6ef5] text-[#6b7fa3] text-sm font-medium"
              >
                {sector}
              </span>
            ))}
      ...
      {/* 7. CTA Banner */}
      <section className="py-16 bg-[#0f1624] bg-gradient-to-b from-[#141f33] to-[#0f1624] rounded-2xl">
      ...
      <footer className="py-8 border-t border-[#2a3a5c]">
        <div className="max-w-4xl mx-auto flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex flex-wrap gap-6 text-sm text-[#6b7fa3]">
          ...
          <p className="text-[#6b7fa3] text-sm self-start sm:self-auto">
